      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div 
              key={index}
              className="bg-blue-900 bg-opacity-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
        ...
        <div className="mt-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-200">Simple steps to get the academic help you need</p>
          </div>
